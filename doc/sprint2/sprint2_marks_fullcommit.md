...
**Team Name:** full commit impaction
...
## Planning Meetings (sprintN.md) (max 2 marks)
  ...
  Planning Meetings Total Mark: 2 / 2, **Please note the participants of the planning meeting more clearly in the future.**
...
## Sprint Review (sprintNreview.md) (max 4 marks)
  ...
  Your Mark: 3, **Please note the participants of the review meeting more clearly in the future.**
...
## User Stories (Tracked in JIRA) (max 10 marks) 
  ...
  - Broken down into tasks/subtasks (max 2 marks)
    ...
    Your Mark: 0, **Please estimate all your stories using story points, as well as break them into subtasks when you start working on them**
  ...
  - Clearly Defined Acceptance Criteria (max 2 marks)
    ...
    Your Mark: 0, No acceptance criteria included in stories
...
## Tracking on JIRA  (max 24 marks) 
  ...
  - Tasks Distribution (max 3 marks)
    ...
    Your Mark: 1, looking at your sprint history, I don't see an issue completed by Darren. Also it seems like only Xiaoran completed issues in this sprint. Please reach out to me if that's not the case.
 ...
 - Burndown chart (max 2 marks)
    ...
    Your Mark: 0, no burn down provided
...
Tracking on JIRA Total Mark: 16 / 24
