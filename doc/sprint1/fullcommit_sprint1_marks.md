...
## Planning Meetings (RPM.md, sprintN.md) (max 8 marks)
  ...
  Your Mark: 1, participants need to be explicitely defined, release goals are unclear, and should make reference to user stories.
  ...
  Planning Meetings Total Mark: 4 / 8
...
## User Stories (Tracked in JIRA) (max 10 marks) 
  ...
  - Broken down into tasks/subtasks (max 2 marks)
    ...
    Your Mark: 2, NOTE: This requirement was not fulfilled, but will give full marks for now. Going forward please break all tasks into subtasks when
    working on an issue.
