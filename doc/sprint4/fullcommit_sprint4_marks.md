...
## Sprint Review (sprintNreview.md) (max 4 marks)
    ...
    Your Mark: 2, no participants recorded
...
## Daily Stand-ups (max 10 marks)
  ...
  Daily Stand-ups Total Mark: 1 / 10, only one person posted a standup
...
Tracking on JIRA Total Mark: 14 / 24
