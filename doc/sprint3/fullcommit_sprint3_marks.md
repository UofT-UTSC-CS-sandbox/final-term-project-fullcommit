...
## Sprint Review (sprintNreview.md) (max 4 marks)
    ...
    Your Mark: 2, Please record participants

    
 
Sprint Review Total Mark: 2 / 4
...
## Daily Stand-ups (max 10 marks)
  ...
  Daily Stand-ups Total Mark: 5 / 10, No standup updates from Catherine Qu
...
## User Stories (Tracked in JIRA) (max 10 marks) 
  ...
  - Broken down into tasks/subtasks (max 2 marks)
    ...
    Your Mark: 0, please break up the stories you work on into subtasks.
  ...
  - Clearly Defined Acceptance Criteria (max 2 marks)
    ...
    Your Mark: 0, no acceptance criteria on majority of stories
...
## Sprint Completion (Max 20 marks) 
 ...
 Sprint Completion Total Mark: 12 / 20
---
...
Sprint Demo Total Mark: 14 / 17, largely consists of hard coded values
